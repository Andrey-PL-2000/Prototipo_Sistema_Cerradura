...
void loop() {
  ...
  if (espSerial.available() > 0) {
    ...
    if (indiceBarra != -1) {  // Si se encontró "/"
      ...
      respuesta += "<body><h1 style=\"text-align: center;\">SISTEMA DE ACCESO AUTOMATICO CONTROLADO"; 
      respuesta += "MEDIANTE PLATAFORMA WEB PARA UN SALON DOMOTIZADO</h1>";
      respuesta += "<h1><a href=\"/Abrir\">Abrir Puerta</a></h1>";
      respuesta += "<h1><a href=\"/Cerrar\">Cerrar Puerta</a></h1>";
      respuesta += "</body></html>\r\n";
