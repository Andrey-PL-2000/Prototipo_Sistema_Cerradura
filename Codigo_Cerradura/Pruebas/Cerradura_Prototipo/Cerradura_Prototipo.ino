...
void loop() {
  ...
  if (espSerial.available() > 0) {
    ...
    if (indiceBarra != -1) {  // Si se encontró "/"
      ...
      // respuesta += "<html lang=\"en\">\n";
      // respuesta += "<head>\n";
      // respuesta += "<meta charset=\"UTF-8\">\n";
      // respuesta += "<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n";
      // respuesta += "<title>G4</title>\n";
      // respuesta += "</head>\n";
      // respuesta += "<body><h1 style=\"text-align: center;\">SISTEMA DE ACCESO AUTOMÁTICO CONTROLADO"; 
      // respuesta += "MEDIANTE PLATAFORMA WEB PARA UN SALÓN DOMOTIZADO</h1>";
      // respuesta += "<body><h2 style=\"text-align: center;\">Control de Cerradura G4</h2>";
      // respuesta += "<p style=\"text-align: center;\"><button onclick=location.href=\"/Cerrar\">Cerrar Puerta</button><br></p>";
      // respuesta += "<p style=\"text-align: center;\"><button onclick=location.href=\"/Abrir\">Abrir Puerta</button><br></p>";
      // respuesta += "<p><strong>Log de Eventos:</strong></p>";
      // respuesta += "<p>" + logMensajes + "</p>";
      // respuesta += "</body></html>\r\n";
      // espSerial.print("AT+CIPSEND=0,");
      // espSerial.println(respuesta.length());
      // enviarComandoAT(respuesta, 1000);
      // enviarComandoAT("AT+CIPCLOSE=0\r\n", 1000);  // Cierra la conexión
